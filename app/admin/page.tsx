...
function MetricCard({
  ...
  const content = (
    <div className="bg-white rounded-lg border border-slate-200 p-3 hover:shadow-md hover:border-slate-300 transition-all group">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] font-medium text-slate-500 uppercase tracking-wider mt-0.5">{label}</p>
        </div>
      </div>
    </div>
  );
